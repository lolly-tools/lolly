...
/** A child render format an embed URL extension can name. */
export type EmbedFormat = 'png' | 'jpg' | 'jpeg' | 'webp' | 'svg' | 'pdf';
...
const EXT_FORMAT: Record<string, EmbedFormat> = { png: 'png', jpg: 'jpg', jpeg: 'jpeg', webp: 'webp', svg: 'svg', pdf: 'pdf' };
