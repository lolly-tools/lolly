...
/**
 * Canvas paint baseline (plans/98 section 9) - the BROWSER half of the harness. Where
 ...
 *   patch  the PHASE-A paint (plans/98 section 5): mutate only the damaged box's node in place - 
