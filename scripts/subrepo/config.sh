...
# 2026-09-10: lolly.art retired. The domain (and www.) sits on the bt project as a
# 308 redirect to lolly.tools at the Vercel domain level; its own project is deleted.
SHIP_TARGETS=(
