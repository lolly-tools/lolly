...
const API_FILE: Record<string, string> = {
  ...
  textTools: 'text-tools', compare: 'compare', prepare: 'prepare', net: 'net', tokens: 'tokens', text: 'text', pdf: 'pdf', pptx: 'pptx', capture: 'capture', compose: 'compose',
...
const API_INTERFACE: Record<string, string> = {
  ...
  textTools: 'TextToolsAPI', compare: 'CompareAPI', prepare: 'PrepareAPI', net: 'NetAPI', tokens: 'TokensAPI', text: 'TextAPI', pdf: 'PdfAPI', pptx: 'PptxAPI', capture: 'CaptureAPI',
