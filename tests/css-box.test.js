 ...
 * Run with: node --test tests/css-box.test.js
 */
...
const corners = (v) => ({ topLeft: v, topRight: v, bottomRight: v, bottomLeft: v });
...
test('insetCorners: shrinks by inset, clamped to 0', () => {
  const r = { topLeft: [10, 10], topRight: [4, 4], bottomRight: [0, 0], bottomLeft: [10, 10] };
