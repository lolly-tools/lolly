...
test('lazy tool, timeline, assets, profile and brand entries retain their required stylesheets', () => {
  const entries: Record<string, string[]> = {
    ...
    'views/assets.ts': ['../styles/parts/platform.css', '../styles/parts/assets.css'],
