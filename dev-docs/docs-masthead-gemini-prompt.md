...
|---|---|---|
| **Model + version** | `meta.model.name` + `model.identifier` → the C2PA **ai-disclosure** assertion (§18.28) | **the model** self-identifies |
...
(§18.28) with no field for a vendor or a datacenter, so grafting them on would
