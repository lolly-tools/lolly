...
/**
 * Assets - browse the SAME on-disk asset registry the web Assets view shows
 ...
 * assets - persisted on the profile like the web Assets view; favourites sort to the top and
...
export function Assets({ onNav, onQuit, onOpenTool }: { onNav: (t: NavTarget) => void; onQuit: () => void; onOpenTool?: (toolId: string, query: string) => void }) {
