...
/**
 * Module-level declarations of assets.ts that its feature modules use: the types,
...
// TypeFilter + its bucket table live in assets-filter.ts with the predicates
...
// collapses to the icon alone on mobile (see .cat-btn-label in styles/parts/assets.css).
 ...
 *  "Save to Assets" delivery signs-and-uploads instead. */
