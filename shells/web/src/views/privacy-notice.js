...
export function privacyNoticeMarkup() {
 ...
 */
export function mountPrivacyNotice(viewEl) {
  const notice = viewEl.querySelector('.privacy-notice');
  if (!notice) return;
  ...
  const footer = viewEl.querySelector('.gallery-footer');
  let ro;
  ...
  notice.querySelector('.privacy-notice-dismiss')?.addEventListener('click', () => {
