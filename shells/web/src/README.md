...
|---|---|---|---|
| `views/` | 270 files, 145,358 lines | 137 files, 52,673 lines | 3 files, 193 lines |
...
Plus 45 `.ts`/`.js` files at the top level of `src/`, 15,079 lines all told, of which 20 are tests and 3 are ambient declarations. `main.ts` is 2,051 of that.
<!-- web-src-dirs:end -->
