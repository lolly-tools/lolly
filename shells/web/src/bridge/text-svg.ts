 ...
 *
 * DOM-free at import so it's unit-testable under node:test (see text-svg.test.ts).
...
export function suseWeightName(weight: number): string {
...
export function suseFontFile(weight: number, italic: boolean): string {
