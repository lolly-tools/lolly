...
| Capability                       | Canva (Open canvas) | Brandfolder Content Automation (DAM templating) | Illustrator / Inkscape (Desktop pro) | Figma / Penpot (Online pro) | **Lolly (Constraints-first)** |
|---|---|---|---|---|---|
...
- One-to-many "fill in three fields, get the finished asset" flows
