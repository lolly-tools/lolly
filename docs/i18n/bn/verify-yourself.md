...
**6. রেন্ডার এন্ডপয়েন্ট শুধুমাত্র পাবলিক ডেটা দিয়ে উত্তর দেয়।** একমাত্র সার্ভার ফিচার যা ব্যবহারকারীর টাইপ করা ইনপুট একটি URL-এ রাখে - হট-লিংক রেন্ডার - এখানে লাইভ আছে, এবং [privacy policy](/info/privacy.html) বলে দেয় আপনি একটি লিংকে যে ইনপুট দেন তার জন্য এর মানে কী:
...
সুইচটি প্রতি-ডিপ্লয়মেন্ট ভিত্তিক (`LOLLY_DISABLE_RENDER_GET=1`): যে ইনস্ট্যান্সে এটি সেট করা থাকে, সেখানে একই প্রোব `404` রিটার্ন করে - এই পার্থক্যটি ফ্ল্যাগ কাজ করার ফল, কোনো অসঙ্গতি নয়।
...
ক্লোনে নিজেই এগুলো চালান (Node 22.18+; এই ফাইলের জন্য `pnpm install`-এর প্রয়োজন নেই):
...
পূর্ণ স্যুট (`pnpm install && pnpm test`) আরও কয়েক হাজার টেস্ট চালায়, যার মধ্যে [Security & Verification](/info/security.html)-এ বর্ণিত অ্যাডভার্সারিয়াল ক্রিপ্টোগ্রাফি টেস্টও রয়েছে।
