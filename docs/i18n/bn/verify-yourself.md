...
**৬. রেন্ডার এন্ডপয়েন্ট শুধুমাত্র পাবলিক ডেটা দিয়ে উত্তর দেয়।** সার্ভারের একমাত্র বৈশিষ্ট্য যা ব্যবহারকারী-টাইপ করা ইনপুট একটি URL-এ রাখে - হট-লিংক রেন্ডার - এখানে লাইভ, এবং [প্রাইভেসি পলিসি](/info/privacy.html) বলে দেয় আপনি একটি লিংকে যে ইনপুট দেন তার জন্য এর মানে কী:
...
সুইচটি প্রতি-ডিপ্লয়মেন্ট ভিত্তিক (`LOLLY_DISABLE_RENDER_GET=1`): যে ইনস্ট্যান্সে এটি সেট করা হয়েছে, সেখানে একই প্রোব `404` ফেরত দেয় - এই পার্থক্যটি ফ্ল্যাগটি কাজ করার প্রমাণ, কোনো অসঙ্গতি নয়।
