...
**ٹرانزیشنز** پری سیٹس ہیں، کی فریمز نہیں: Fade، Pop، Grow، Rise، Drop، چاروں Slides، Zoom in اور out، Tilt، Swoop، Spin، Drift یا **Cut (no animation)**۔ فاصلے آبجیکٹ کے ساتھ اسکیل ہوتے ہیں، تو ایک ہی پری سیٹ پورے فریم کے کارڈ اور چھوٹے بیج دونوں پر درست لگتا ہے۔ سیکوئنس رو پر دو ملحقہ کلپس کے درمیان ایک **سیم چِپ** ہوتی ہے: اس پر کلک کر کے **Cut** یا **Crossfade** چنیں، جو فوراً لاگو ہو کر بند ہو جاتی ہے۔ **Length (ms)** بدلنے کے لیے وہی چِپ دوبارہ کھولیں اور **Done** دبائیں۔ کراس فیڈ ایک کلپ کے فیڈ آؤٹ اور اگلے کے فیڈ اِن کے طور پر محفوظ ہوتا ہے، اور اصل ڈزالو اسی جوڑے سے اخذ ہوتا ہے: پہلا کلپ کٹ کے بعد بھی چلتا رہتا ہے اور فیڈ آؤٹ ہوتا ہے، جبکہ اگلا کلپ اس کے نیچے فیڈ اِن ہوتا ہے۔ پیش نظارہ اور فائل ایک ہی اصول پر عمل کرتے ہیں، اس لیے سیم پر جو نظر آتا ہے وہی ایکسپورٹ ہوتا ہے۔
...
اثاثوں میں موجود **Swatches** پینل صرف دکھاتا نہیں - کسی رنگ پر کلک کر کے اسے کاپی کریں، یا **پورا برانڈ پیلیٹ ڈاؤن لوڈ کریں** اسی فارمیٹ میں جو آپ کا دوسرا ٹول سمجھتا ہے:
...
![Swatches پینل - اوپر پیلیٹ ڈاؤن لوڈ کے پانچ بٹن، پھر ہر برانڈ رنگ ایک قابلِ کاپی چِپ کے طور پر](/t/url-shot?url=%2F%23%2Fa%3Fsection%3Dswatches&width=1440&height=900&dpi=96&waitMs=1800&css=.cat-group%3Anot%28%5Bdata-group%3Dswatches%5D%29%7Bdisplay%3Anone%7D&cropSelector=%5Bdata-group%3Dswatches%5D&walker=1&format=svg&dark=1&filename=use-swatch-downloads)
