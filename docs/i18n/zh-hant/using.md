...
- <!--i:upload--> **匯入你的檔案。** 將任何圖片、SVG、音訊片段、影片、Lottie、PDF 或 PowerPoint 簡報拖放到上傳區——或點擊以選擇——即可立即加入你的目錄,並在每個工具的素材選取器中隨時可用。多頁 PDF 或 `.pptx` 會詢問要保留哪些頁面或投影片——每一頁都會成為一個 SVG 素材。想匯入多少都可以;內容永遠不會離開你的裝置。
