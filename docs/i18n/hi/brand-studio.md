...
आपका ब्रांड जो फ़ाइलें रखता है - लोगो को छोड़कर - उन्हें यहाँ छोड़ें: **vector**, **image**, **audio** और **motion** (वीडियो, Lottie, एनिमेटेड) एसेट। ये [एसेट](/info/using.html#assets-your-library) में उतरते हैं, सेक्शन में क्रमबद्ध और हर टूल के एसेट पिकर में तैयार। सब कुछ इसी डिवाइस पर रहता है। (रेल इस रूम को **Files** लेबल करता है; URL की `catalogue` ही रहती है, क्योंकि पैनल की की एक स्थायी अनुबंध है।)
...
- **[Lolly का उपयोग](/info/using.html)** - कैनवस, सेव करना, प्रोजेक्ट्स और एसेट।
