...
**6. रेंडर एंडपॉइंट केवल सार्वजनिक डेटा के साथ उत्तर देता है।** एकमात्र सर्वर सुविधा जो उपयोगकर्ता द्वारा टाइप किए गए इनपुट को URL में डालती है - हॉट-लिंक रेंडर - यहाँ लाइव है, और [privacy policy](/info/privacy.html) बताती है कि आपके द्वारा किसी लिंक में डाले गए इनपुट के लिए इसका क्या मतलब है:
...
यह स्विच प्रति-डिप्लॉयमेंट है (`LOLLY_DISABLE_RENDER_GET=1`): जिस इंस्टेंस पर यह सेट है, वहाँ वही प्रोब `404` लौटाती है - यह अंतर फ़्लैग के काम करने का संकेत है, कोई असंगति नहीं।
...
इन्हें अपने क्लोन में खुद चलाएँ (Node 22.18+; इस फ़ाइल के लिए `pnpm install` की ज़रूरत नहीं):
...
पूरा सूट (`pnpm install && pnpm test`) कई हज़ार और टेस्ट चलाता है, जिसमें [Security & Verification](/info/security.html) में वर्णित एडवर्सेरियल क्रिप्टोग्राफ़ी टेस्ट भी शामिल हैं।
