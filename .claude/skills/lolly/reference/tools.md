...
| `agenda` | Agenda | event | pdf, pdf-cmyk, svg, penpot, png, jpg, webp, ics, html, mp4, webm, pptx, zip | - | - | Turn one programme into branded screens, interactive web pages, animated overviews, PowerPoint slides and calendars. |
...
| `certificate` | Certificate | everyone | pdf, pdf-cmyk, svg, penpot, png, jpg, webp, tiff, cmyk-tiff | - | - | Completion and award certificates from the active design system - one name at a time, or a whole roster from a CSV in… |
...
| `darkroom` | Darkroom | designer | png, jpg, webp, svg, penpot, webm, mp4, exr, hdr, tiff, pdf, avif | - | - | A pro photo-grading darkroom: film looks, third-party .cube LUTs, design system colour treatments and finishing textu… |
| `deck-studio` | Markdown Slides | designer | pptx, pdf, png, html, jpg, webp | - | - | Turn Markdown or a JSON spec into a native, editable PowerPoint deck - real text, bullets, tables and the design syst… |
| `design` | Design | designer | png, svg, penpot, pdf, pdf-cmyk, cmyk-tiff, jpg, webp, mp4, webm, gif, apng, wav, mp3, m4a, opus, pptx, scorm, avif, tiff, emf, webp-anim, lottie | - | - | An open canvas for free arrangement - text, images, shapes and live renders from your other Lolly tools, all held to… |
...
| `frame` | Frame | everyone | png, jpg, webp, svg, penpot, pdf, avif, tiff | - | - | Drop in a screenshot and get it framed, padded and shadowed on a design system backdrop. |
| `gradient` | Gradient | everyone | svg, penpot, png, jpg, webp, avif, webm, mp4, gif, pdf, tiff, webp-anim | - | - | Five ways to build a gradient from the design system swatches: soft radial Blend, a real Coons-patch mesh as crisp SV… |
...
| `link-card` | Link Card | everyone | png, jpg, webp, svg, penpot, pdf, avif, tiff | - | - | Paste a link, get a social card in your design system - title, description, site chip and a thumbnail, at Open Graph,… |
...
| `contrast-check` | Contrast | utility | svg, penpot, png, pdf, csv, json, jpg, webp, avif | - | - | Check a text and background pair, or every pairing in the design system palette, against WCAG 2.1 and APCA, and see h… |
