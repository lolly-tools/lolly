...
| `community/` | 26 brand-agnostic tool dirs (qr-code, street-map, strip-data, text-helper, mesh-gradient, chart-creator, d3, color-palette, compress-pdf, countdown-timer, url-shot, filter-*) — public submodule `lolly-tools` |
