...
**6. रेंडर एंडपॉइंट केवल सार्वजनिक डेटा से जवाब देता है।** एकमात्र सर्वर फ़ीचर जो यूज़र-टाइप किए इनपुट को URL में डालता है - hot-link रेंडर - यहां लाइव है, और [privacy policy](/info/privacy.html) बताती है कि इसका मतलब उन इनपुट के लिए क्या है जो आप किसी लिंक में डालते हैं:
...
यह स्विच प्रति-डिप्लॉयमेंट है (`LOLLY_DISABLE_RENDER_GET=1`): जिस इंस्टेंस में यह सेट किया गया है, वहां वही प्रोब `404` लौटाता है - यह अंतर फ़्लैग के काम करने का प्रमाण है, कोई असंगति नहीं।
