...
সুইচটি প্রতি-ডিপ্লয়মেন্ট ভিত্তিক (`LOLLY_DISABLE_RENDER_GET=1`): যে ইনস্ট্যান্সে এটি সেট করা হয়নি, সেখানে হট-লিংক রেন্ডার সক্রিয় থাকে, তাই সেখানে একই প্রোব একটি ছবি ফেরত দেয় - এই পার্থক্যটি ফ্ল্যাগটি কাজ করার প্রমাণ, কোনো অসঙ্গতি নয়।
