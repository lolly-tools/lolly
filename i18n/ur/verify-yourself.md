...
یہ سوئچ فی تعیناتی (per-deployment) ہے (`LOLLY_DISABLE_RENDER_GET=1`): جس انسٹنس پر یہ سیٹ نہ کیا گیا ہو، وہاں hot-link renders فعال رہتے ہیں، اس لیے وہاں وہی جانچ ایک تصویر لوٹاتی ہے - یہ فرق فلیگ کے کام کرنے کی علامت ہے، نہ کہ کوئی تضاد۔
