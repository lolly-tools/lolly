...
Превключвателят е за всяко разгръщане поотделно (`LOLLY_DISABLE_RENDER_GET=1`): на инстанс, който оставя тази променлива незададена, визуализациите чрез директен линк са активни, така че същата проверка там връща изображение - тази разлика е знак, че флагът работи, а не несъответствие.
