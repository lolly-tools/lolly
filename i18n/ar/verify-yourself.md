...
المفتاح لكل نشر على حدة (`LOLLY_DISABLE_RENDER_GET=1`): على نسخة تترك هذا المتغير غير معين، تكون عمليات العرض بالربط المباشر مُفعّلة، لذا فإن نفس الفحص هناك يُعيد صورة - هذا الفرق هو عمل العلَم كما يجب، لا تضاربًا.
