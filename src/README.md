...
| `lib/` | 489 files, 112,101 lines | 296 files, 58,723 lines | 10 files, 1,256 lines |
| `bridge/` | 129 files, 45,399 lines | 85 files, 20,066 lines | none |
...
| `styles/` | none | 4 files, 837 lines | 81 files, 42,758 lines |
