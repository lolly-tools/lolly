 ...
 * reached via a link, i.e. a share/bookmark round-trip. A selection made by an
 ...
 *     reveal this session. That reveal is device-local memory, never written to the URL.
